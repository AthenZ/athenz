...
mvn deploy -Dmaven.test.skip=true --projects com.yahoo.athenz:zms_assembly --settings travis/settings-athenz-zms.xml
mvn deploy -Dmaven.test.skip=true --projects com.yahoo.athenz:zts_assembly --settings travis/settings-athenz-zts.xml
mvn deploy -Dmaven.test.skip=true --projects com.yahoo.athenz:zpu_assembly --settings travis/settings-athenz-zpu.xml
mvn deploy -Dmaven.test.skip=true --projects com.yahoo.athenz:ui_assembly --settings travis/settings-athenz-ui.xml
mvn deploy -Dmaven.test.skip=true --projects com.yahoo.athenz:utils_assembly --settings travis/settings-athenz-utils.xml
