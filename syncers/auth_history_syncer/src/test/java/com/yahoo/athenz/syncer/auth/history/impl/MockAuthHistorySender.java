...
public class MockAuthHistorySender implements AuthHistorySender {
    private static final Logger LOGGER = LoggerFactory.getLogger(MockAuthHistorySender.class);

    @Override
    public void pushRecords(Set<AuthHistoryDynamoDBRecord> logs) {
        LOGGER.info("Mock pushing records....");
    }
}
