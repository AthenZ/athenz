...
public class DomainData {
    ...
    public DomainData setAwsAccountName(String awsAccountName) {
    ...
    public DomainData setSlackChannel(String slackChannel) {
    ...
    public DomainData setClientIdSelfUpdate(Boolean clientIdSelfUpdate) {
    ...
    public DomainData setExternalMemberValidator(String externalMemberValidator) {
