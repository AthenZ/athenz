...
public class ZMSSchema {
    ...
    private static Schema build() {
        ...
        sb.structType("Policy")
            ...
            .field("caseSensitive", "Bool", true, "If true, we should store assertion action and resource in their original case");
...
;
        ...
        sb.resource("Access", "GET", "/access/{action}/{resource}")
            ...
            .queryParam("casesensitive", "isCaseSensitive", "BOOL", null, "usually false. If true, keep action and resource case-sensitive")
            .auth("", "", true)
            .expected("OK")
            .exception("BAD_REQUEST", "ResourceError", "")
