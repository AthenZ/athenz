...
public class TopLevelDomain {
    ...
    public TopLevelDomain setAwsAccountName(String awsAccountName) {
    ...
    public TopLevelDomain setClientIdSelfUpdate(Boolean clientIdSelfUpdate) {
    ...
    public TopLevelDomain setCostCenter(String costCenter) {
