...
public class TransportPolicyValidationStatusTest {
    ...
    public void testTransportPolicyValidationStatus() {
        ...
        TransportPolicyValidationStatus tpvs1 = TransportPolicyValidationStatus.ALL;
        assertTrue(tpvs1 == tpvs1);
        assertFalse(tpvs1.equals("abc"));

        TransportPolicyValidationStatus tpvs2 = TransportPolicyValidationStatus.NONE;
        assertFalse(tpvs1 == tpvs2);

        tpvs2 = TransportPolicyValidationStatus.ALL;
        ...
        assertEquals(TransportPolicyValidationStatus.fromString("ALL"), TransportPolicyValidationStatus.ALL);
