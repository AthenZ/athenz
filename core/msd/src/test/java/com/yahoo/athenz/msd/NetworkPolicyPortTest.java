...
public class NetworkPolicyPortTest {

    @Test
    public void testFields() {
        NetworkPolicyPort tpp1 = new NetworkPolicyPort().setPort(1024).setEndPort(65535).setProtocol(TransportPolicyProtocol.TCP);
        ...
        NetworkPolicyPort tpp2 = new NetworkPolicyPort().setPort(1024).setEndPort(65535).setProtocol(TransportPolicyProtocol.TCP);
