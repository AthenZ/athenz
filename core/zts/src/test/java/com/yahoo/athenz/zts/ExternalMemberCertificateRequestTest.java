...
public class ExternalMemberCertificateRequestTest {

    @Test
    public void testExternalMemberCertificateRequest() {
        ExternalMemberCertificateRequest r1 = new ExternalMemberCertificateRequest();
        r1.setName("email:ext.joe@athenz.io");
        r1.setCsr("test_csr");
        r1.setAttestationData("attestation_data");
        r1.setExpiryTime(123456789);
        r1.setX509CertSignerKeyId("x509KeyId");

        ExternalMemberCertificateRequest r2 = new ExternalMemberCertificateRequest();
        r2.setName("email:ext.joe@athenz.io");
        r2.setCsr("test_csr");
        ...
        // getters
        assertEquals(r1.getName(), "email:ext.joe@athenz.io");
        ...
        r2.setName("email:ext.jane@athenz.io");
