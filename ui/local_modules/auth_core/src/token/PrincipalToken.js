...
class PrincipalToken extends Token {
  ...
  parseSignedToken(signedToken) {
    ...
    if (this._authorizedServices !== null) {
      winston.debug(
  ...
  builder(options) {
    if (options.version == null || options.domain == null || options.name == null) {
    ...
    this._ip = options.ip;
    this._authorizedServices = (options.authorizedServices != null) ? options.authorizedServices.split(',') : null;
    ...
    if (this._keyService !== null) {
      parts.push('z=' + this._keyService);
    }
    if (this._originalRequestor !== null) {
  ...
  signForAuthorizedService(authorizedServiceName, authorizedServiceKeyId, privateKey) {
    ...
    if (this._authorizedServices === null || this._authorizedServices.indexOf(authorizedServiceName) === -1) {
  ...
  validateForAuthorizedService(publicKey) {
    var err = null;
    if (this._authorizedServiceSignature === null) {
  ...
  isValidAuthorizedServiceToken() {
    ...
    if (this._authorizedServiceName !== null) {
