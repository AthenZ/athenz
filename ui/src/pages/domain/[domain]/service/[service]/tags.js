...
class ServiceTagsPage extends React.Component {
    constructor(props) {
        super(props);
        this.api = API();
    ...
    componentDidMount() {
        const { domainName, userName, getDomainData, getServices } = this.props;
        Promise.all([
    ...
    render() {
        ...
        return isLoading.includes('getDomainData') ? (
            ...
            <CacheProvider value={this.cache}>
                <div data-testid='service-tags'>
                    <Head>
                        <title>Athenz Service Tags</title>
                    </Head>
...
export default connect(mapStateToProps, mapDispatchToProps)(ServiceTagsPage);
