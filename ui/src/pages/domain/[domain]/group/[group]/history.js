...
import {selectGroup, selectGroupHistory,} from '../../../../../redux/selectors/group';
            ...
            <div data-testid='member'>
                ...
                <MainContentDiv>
                    <AppContainerDiv>
                        ...
                        <UserDomains api={this.api} domain={domain}/>
                    </AppContainerDiv>
                </MainContentDiv>
            </div>
        );
...
const mapStateToProps = (state, props) => {
    return {
        ...
        collectionDetails: selectGroup(state, props.groupName),
        historyrows: selectGroupHistory(state, props.groupName),
    };
};
