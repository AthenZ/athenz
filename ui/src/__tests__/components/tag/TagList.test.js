...
describe('TagList', () => {
    ...
    it('should display delete tag', async () => {
        ...
        await waitFor(() =>
            screen.getByText('Are you sure you want to permanently delete the Tag', {exact: false})
        );
        expect(screen.getByText('Are you sure you want to permanently delete the Tag', {exact: false})).toBeInTheDocument();
    ...
    it('should display delete tag value', async () => {
        ...
        await waitFor(() =>
            screen.getByText('Are you sure you want to permanently delete the Tag Value', {exact: false})
        );
        expect(screen.getByText('Are you sure you want to permanently delete the Tag Value', {exact: false})).toBeInTheDocument();
    ...
    it('should display add tag', async () => {
        ...
        await waitFor(() =>
            screen.getByText('Add Tag to domain')
        );
    ...
    it('should display edit tag', async () => {
        ...
        await waitFor(() =>
            screen.getByText('Edit tag-key Tag')
        );
