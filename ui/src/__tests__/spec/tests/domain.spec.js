...
const { ONCALL_TEAM_URL } = require('../../../components/constants/constants');
...
const TEST_ADD_ON_CALL_TEAM =
    'modal to add on call team name - should successfully save an on call team and have a redirect link to rootly';
...
describe('Domain', () => {
    ...
    it(TEST_ADD_ON_CALL_TEAM, async () => {
        ...
        await expect(onCallLink).toEqual(
            `${ONCALL_TEAM_URL}/${ONCALL_TEAM_NAME}`
        );
