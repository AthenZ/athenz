...
// export const isExistInDomainsCache = (state, domainName, collection) => {
//     return (
//         selectDomainsCache(state) &&
//         selectCollectionFromDomainCache(state, domainName, collection) &&
//         !isExpired(selectExpiryFromDomainCache(state, domainName, collection))
//     );
// };
