...
export const ADD_SUB_DOMAIN = 'ADD_SUB_DOMAIN';
export const addSubDomainToStore = (domainName) => ({
    type: ADD_SUB_DOMAIN,
    payload: { name: domainName, adminDomain: true },
});

export const ADD_USER_DOMAIN = 'ADD_USER_DOMAIN';
export const addUserDomainToStore = (domainName) => ({
    type: ADD_USER_DOMAIN,
    payload: { name: domainName, adminDomain: true },
});

export const DELETE_SUB_DOMAIN = 'DELETE_SUB_DOMAIN';
export const deleteSubDomainFromStore = (subDomain) => ({
...
export const processPendingMembersToStore = (domainName, member, roleName) => ({
    type: PROCESS_PENDING_MEMBERS_TO_STORE,
    payload: { member, domainName, roleName },
});
