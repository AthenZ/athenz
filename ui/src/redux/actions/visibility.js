...
export const loadServiceDependencies = ( serviceDependencies, domainName, expiry) => ({
    type: LOAD_SERVICE_DEPENDENCIES,
    payload: { serviceDependencies: serviceDependencies, domainName: domainName, expiry: expiry },
});
