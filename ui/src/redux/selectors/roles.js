...
// export const selectMemberRoles = (state, memberName) => {
//     return state.roles.roleUsers &&
//         state.roles.roleUsers.members &&
//         state.roles.roleUsers.members[memberName]
//         ? mapToList(state.roles.roleUsers.members[memberName].memberRoles)
//         : [];
// };

// export const selectUserMemberData = (state, memberName) => {
//     return state.roles.roleUsers &&
//         state.roles.roleUsers.members &&
//         state.roles.roleUsers.members[memberName]
//         ? state.roles.roleUsers.members[memberName]
