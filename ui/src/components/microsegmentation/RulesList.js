...
export default class RulesList extends React.Component {
    ...
    render() {
        ...
        let showInbound = this.state.segmentationData && this.state.segmentationData.inbound.length > 0;
        let showOutbound = this.state.segmentationData && this.state.segmentationData.outbound.length > 0;
