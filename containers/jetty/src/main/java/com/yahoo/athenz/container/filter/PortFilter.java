...
public class PortFilter implements jakarta.servlet.Filter {
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse,
        ...
        if (useConfiguration) {
            handleConfigurationBased(request, response, chain);
        } else {
    ...
    /**
     * Handle filtering using port-uri.json configuration
     */
    private void handleConfigurationBased(HttpServletRequest request,
        ...
        LOGGER.debug("Request {} {} rejected on port {} (no matching endpoint)", method, requestUri, localPort);
