...
2024/02/15 17:05:43 Job Workflow Ref Resource: athens.github:yahoo-athenz/sia:refs/heads/main:yahoo-athenz/sia/.github/workflows/build.yml@refs/heads/main
```
...
based check fails. The `Job Workflow Ref Resource` value shows the resource used for that check
