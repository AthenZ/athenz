...
// Start: can be set by the build script using LDFLAGS
var Version string
...
func getAccountFromCreds() (string, string, error) {
...
func main() {
	...
	accountId, region, err := getAccountFromCreds()
	if err != nil {
