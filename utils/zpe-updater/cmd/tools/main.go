	...
	if logFile != "" {
		...
		if err != nil {
			log.Fatalf("The log file:%v cannot be opened, Error:%v. \n "+
				"If you donot have write access to the default log file /home/athenz/logs/zpu/zpu.log, use the -logFile flag to overwrite the default value. \n"+
				"Usage : zpu -athenzConf <Athenz log file> -zpuConf <zpu conf file> -logFile <log file name>. ", logFile, err)
		}
		f.Close()
