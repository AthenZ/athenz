...
//
//	mockgen -destination=./client/mock_client.go -package=client -source=client/client.go MsdClient
//
...
func (m *MockMsdClient) PutWorkload(domain, service string, options *msd.WorkloadOptions, resourceOwner string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "PutWorkload", domain, service, options, resourceOwner)
	ret0, _ := ret[0].(error)
	return ret0
}
...
func (mr *MockMsdClientMockRecorder) PutWorkload(domain, service, options, resourceOwner any) *gomock.Call {
	...
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "PutWorkload", reflect.TypeOf((*MockMsdClient)(nil).PutWorkload), domain, service, options, resourceOwner)
}
