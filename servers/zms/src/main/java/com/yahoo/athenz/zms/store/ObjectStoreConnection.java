...
public interface ObjectStoreConnection extends Closeable {
    ...
    boolean updateRoleReviewAndModTimestamp(String domainName, String roleName);
    ...
    boolean updatePendingRoleMembersNotificationTimestamp(String server, long timestamp);
