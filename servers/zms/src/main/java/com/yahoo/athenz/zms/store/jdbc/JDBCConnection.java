...
public class JDBCConnection implements ObjectStoreConnection {
    ...
    private static final String SQL_UPDATE_ROLE_REVIEW_TIMESTAMP = "UPDATE role "
            + "SET modified=CURRENT_TIMESTAMP(3),last_reviewed_time=CURRENT_TIMESTAMP(3) WHERE role_id=?;";
