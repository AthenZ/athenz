...
import static com.yahoo.athenz.common.server.notification.NotificationServiceConstants.NOTIFICATION_DETAILS_DOMAIN;
...
public class RoleMemberNotificationCommon {
    ...
    public List<Notification> getNotificationDetails(List<Notification> notificationList,
                                                     ...
                                                     String principalsNotificationType,
                                                     String domainAdminsNotificationType,
        ...
        for (DomainRoleMember roleMember : expiryMembers.values()) {
            ...
            Map<String, String> details = processRoleReminder(domainAdminMap, roleMember, principalsNotificationType);
            Notification notification = notificationCommon.createNotification(
                    principalsNotificationType,
        ...
        for (Map.Entry<String, List<MemberRole>> domainAdmin : domainAdminMap.entrySet()) {
            ...
            Map<String, String> details = processMemberReminder(domainAdmin.getKey(), domainAdmin.getValue(), domainAdminsNotificationType);
            Notification notification = notificationCommon.createNotification(
                    domainAdminsNotificationType,
    ...
    public Map<String, String> processRoleReminder(Map<String, List<MemberRole>> domainAdminMap,
        ...
        for (MemberRole memberRole : memberRoles) {
            ...
            Timestamp entryDate = (principalsNotificationType == NOTIFICATION_TYPE_PRINCIPAL_EXPIRY_REMINDER) ? memberRole.getExpiration() : memberRole.getReviewReminder();
    ...
    public Map<String, String> processMemberReminder(final String domainName,
                                                     ...
                                                     String domainAdminNotificationType) {
        ...
        for (MemberRole memberRole : memberRoles) {
            ...
            Timestamp entryDate = (domainAdminNotificationType == NOTIFICATION_TYPE_DOMAIN_MEMBER_EXPIRY_REMINDER) ? memberRole.getExpiration() : memberRole.getReviewReminder();
            String entryDateStr = (entryDate != null) ? entryDate.toString() : "";
