...
public interface ZMSHandler { 
    ...
    void putMembershipAttribute(ResourceContext context, String domainName, String roleName, String memberName, String attribute, String auditRef, Membership membership);
