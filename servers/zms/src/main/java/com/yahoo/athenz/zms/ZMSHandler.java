...
public interface ZMSHandler { 
    ...
    Domain putDomainMeta(ResourceContext context, String name, String auditRef, DomainMeta detail);
    Domain putDomainSystemMeta(ResourceContext context, String name, String attribute, String auditRef, DomainMeta detail);
    DomainTemplate putDomainTemplate(ResourceContext context, String name, String auditRef, DomainTemplate domainTemplate);
    DomainTemplate putDomainTemplateExt(ResourceContext context, String name, String template, String auditRef, DomainTemplate domainTemplate);
    ...
    Entity putEntity(ResourceContext context, String domainName, String entityName, String auditRef, Entity entity);
    ...
    Role putRole(ResourceContext context, String domainName, String roleName, String auditRef, Role role);
    ...
    Membership putMembership(ResourceContext context, String domainName, String roleName, String memberName, String auditRef, Membership membership);
    ...
    DefaultAdmins putDefaultAdmins(ResourceContext context, String domainName, String auditRef, DefaultAdmins defaultAdmins);
    Role putRoleSystemMeta(ResourceContext context, String domainName, String roleName, String attribute, String auditRef, RoleSystemMeta detail);
    Role putRoleMeta(ResourceContext context, String domainName, String roleName, String auditRef, RoleMeta detail);
    Membership putMembershipDecision(ResourceContext context, String domainName, String roleName, String memberName, String auditRef, Membership membership);
    Role putRoleReview(ResourceContext context, String domainName, String roleName, String auditRef, Role role);
    ...
    Group putGroup(ResourceContext context, String domainName, String groupName, String auditRef, Group group);
    ...
    GroupMembership putGroupMembership(ResourceContext context, String domainName, String groupName, String memberName, String auditRef, GroupMembership membership);
    ...
    Group putGroupSystemMeta(ResourceContext context, String domainName, String groupName, String attribute, String auditRef, GroupSystemMeta detail);
    Group putGroupMeta(ResourceContext context, String domainName, String groupName, String auditRef, GroupMeta detail);
    GroupMembership putGroupMembershipDecision(ResourceContext context, String domainName, String groupName, String memberName, String auditRef, GroupMembership membership);
    Group putGroupReview(ResourceContext context, String domainName, String groupName, String auditRef, Group group);
    ...
    Policy putPolicy(ResourceContext context, String domainName, String policyName, String auditRef, Policy policy);
    ...
    Policy putPolicyVersion(ResourceContext context, String domainName, String policyName, PolicyOptions policyOptions, String auditRef);
    Policy setActivePolicyVersion(ResourceContext context, String domainName, String policyName, PolicyOptions policyOptions, String auditRef);
    void deletePolicyVersion(ResourceContext context, String domainName, String policyName, String version, String auditRef);
    ServiceIdentity putServiceIdentity(ResourceContext context, String domain, String service, String auditRef, ServiceIdentity detail);
    ...
    PublicKeyEntry putPublicKeyEntry(ResourceContext context, String domain, String service, String id, String auditRef, PublicKeyEntry publicKeyEntry);
    void deletePublicKeyEntry(ResourceContext context, String domain, String service, String id, String auditRef);
    ServiceIdentity putServiceIdentitySystemMeta(ResourceContext context, String domain, String service, String attribute, String auditRef, ServiceIdentitySystemMeta detail);
