...
public interface ZMSHandler { 
    ...
    SelfServeObjects getSelfServeRoles(ResourceContext context, String matchString, Boolean memberOnly);
    SelfServeObjects getSelfServeGroups(ResourceContext context, String matchString, Boolean memberOnly);
