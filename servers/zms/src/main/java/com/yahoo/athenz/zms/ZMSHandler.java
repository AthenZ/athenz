...
public interface ZMSHandler { 
    ...
    Response putDomainMeta(ResourceContext context, String name, String auditRef, Boolean returnObj, DomainMeta detail);
    Response putDomainSystemMeta(ResourceContext context, String name, String attribute, String auditRef, Boolean returnObj, DomainMeta detail);
    Response putDomainTemplate(ResourceContext context, String name, String auditRef, Boolean returnObj, DomainTemplate domainTemplate);
    Response putDomainTemplateExt(ResourceContext context, String name, String template, String auditRef, Boolean returnObj, DomainTemplate domainTemplate);
    ...
    Response putDefaultAdmins(ResourceContext context, String domainName, String auditRef, Boolean returnObj, DefaultAdmins defaultAdmins);
    Response putRoleSystemMeta(ResourceContext context, String domainName, String roleName, String attribute, String auditRef, Boolean returnObj, RoleSystemMeta detail);
    Response putRoleMeta(ResourceContext context, String domainName, String roleName, String auditRef, Boolean returnObj, RoleMeta detail);
    Response putMembershipDecision(ResourceContext context, String domainName, String roleName, String memberName, String auditRef, Boolean returnObj, Membership membership);
    ...
    Response putGroupSystemMeta(ResourceContext context, String domainName, String groupName, String attribute, String auditRef, Boolean returnObj, GroupSystemMeta detail);
    Response putGroupMeta(ResourceContext context, String domainName, String groupName, String auditRef, Boolean returnObj, GroupMeta detail);
    Response putGroupMembershipDecision(ResourceContext context, String domainName, String groupName, String memberName, String auditRef, Boolean returnObj, GroupMembership membership);
    ...
    Response putAssertion(ResourceContext context, String domainName, String policyName, String auditRef, Boolean returnObj, Assertion assertion);
    Response putAssertionPolicyVersion(ResourceContext context, String domainName, String policyName, String version, String auditRef, Boolean returnObj, Assertion assertion);
    ...
    Response putAssertionConditions(ResourceContext context, String domainName, String policyName, Long assertionId, String auditRef, Boolean returnObj, AssertionConditions assertionConditions);
    Response putAssertionCondition(ResourceContext context, String domainName, String policyName, Long assertionId, String auditRef, Boolean returnObj, AssertionCondition assertionCondition);
    ...
    Response setActivePolicyVersion(ResourceContext context, String domainName, String policyName, PolicyOptions policyOptions, String auditRef, Boolean returnObj);
    ...
    Response putPublicKeyEntry(ResourceContext context, String domain, String service, String id, String auditRef, Boolean returnObj, PublicKeyEntry publicKeyEntry);
    void deletePublicKeyEntry(ResourceContext context, String domain, String service, String id, String auditRef);
    Response putServiceIdentitySystemMeta(ResourceContext context, String domain, String service, String attribute, String auditRef, Boolean returnObj, ServiceIdentitySystemMeta detail);
