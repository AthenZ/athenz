...
public class JDBCConnectionTest {
    ...
    public void testUpdateDomain() throws Exception {
        ...
        Mockito.verify(mockPrepStmt, times(1)).setString(23, "my-domain");
        jdbcConn.close();
    }
    ...
    public void testUpdateRole() throws Exception {
        ...
        Mockito.verify(mockPrepStmt, times(1)).setInt(19, 4);
        jdbcConn.close();
    }
    ...
    public void testUpdateRoleWithTrust() throws Exception {
        ...
        Mockito.verify(mockPrepStmt, times(1)).setInt(19, 7);
        jdbcConn.close();
    }
