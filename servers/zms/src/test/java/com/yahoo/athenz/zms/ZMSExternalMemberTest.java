...
public class ZMSExternalMemberTest {
    ...
    public void testValidateExternalMemberWildcardAtEnd() {
        ...
        zmsImpl.validateExternalMember(domainName, domainName + ":ext.partner*", "testCaller");
    ...
    public void testValidateExternalMemberWildcardOnly() {
        ...
        zmsImpl.validateExternalMember(domainName, "*", "testCaller");

        zmsImpl.deleteTopLevelDomain(ctx, domainName, auditRef, null);
    }

    @Test
    public void testValidateExternalMemberWildcardInMiddle() {
        ...
        try {
            zmsImpl.validateExternalMember(domainName, domainName + ":ext.part*ner", "testCaller");
            fail();
        } catch (ResourceException ex) {
            assertEquals(ex.getCode(), ResourceException.BAD_REQUEST);
    ...
    @Test
    public void testValidateExternalMemberWildcardAtBeginning() {

        ZMSImpl zmsImpl = zmsTestInitializer.getZms();
        RsrcCtxWrapper ctx = zmsTestInitializer.getMockDomRsrcCtx();
        final String auditRef = zmsTestInitializer.getAuditRef();

        final String domainName = "ext-validate-wc-begin";
        ...
        try {
            zmsImpl.validateExternalMember(domainName, "*partner-user", "testCaller");
            fail();
        } catch (ResourceException ex) {
            assertEquals(ex.getCode(), ResourceException.BAD_REQUEST);
            assertTrue(ex.getMessage().contains("is not valid"));
    ...
    @Test
    public void testValidateExternalMemberMultipleWildcards() {

        ZMSImpl zmsImpl = zmsTestInitializer.getZms();
        RsrcCtxWrapper ctx = zmsTestInitializer.getMockDomRsrcCtx();
        final String auditRef = zmsTestInitializer.getAuditRef();

        final String domainName = "ext-validate-multi-wc";
    ...
    public void testValidateExternalMemberInvalidMember() {
        ...
        try {
            zmsImpl.validateExternalMember(domainName, domainName + ":ext.invalid-user", "testCaller");
            fail();
        } catch (ResourceException ex) {
            assertEquals(ex.getCode(), ResourceException.BAD_REQUEST);
    ...
    public void testValidateExternalMemberInvalidMemberWithWildcard() {
        ...
        try {
            zmsImpl.validateExternalMember(domainName, domainName + ":ext.invalid*", "testCaller");
            fail();
        } catch (ResourceException ex) {
            assertEquals(ex.getCode(), ResourceException.BAD_REQUEST);
            assertTrue(ex.getMessage().contains("is not valid according to the external member validator for domain "
    ...
    @Test
    public void testValidateExternalMemberNoValidatorWildcardInMiddle() {

        ZMSImpl zmsImpl = zmsTestInitializer.getZms();
        RsrcCtxWrapper ctx = zmsTestInitializer.getMockDomRsrcCtx();
        final String auditRef = zmsTestInitializer.getAuditRef();

        final String domainName = "ext-validate-nv-wcm";
        ...
        // wildcard-in-middle check runs before the validator lookup,
        // so it should fail with "is not valid" even without a validator
