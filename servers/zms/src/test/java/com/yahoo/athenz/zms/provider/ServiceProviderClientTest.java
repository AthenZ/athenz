...
public class ServiceProviderClientTest {
    ...
    private void serviceProviderClientWithInstance(boolean isInstanceProvider) throws IOException {
        ...
        DomainDependencyProviderResponse dependencyStatus = serviceProviderClient.getDependencyStatus(provider, providerEndpoint, isInstanceProvider, domain, principal);
    ...
    public void testServiceProviderClientHomeDomain() throws KeyRefresherException, IOException, InterruptedException {
        ...
        HttpDriver httpDriver = Mockito.mock(HttpDriver.class);
        ServiceProviderClient serviceProviderClient = new ServiceProviderClient(httpDriver, "home.");
        DomainDependencyProviderResponse dependencyStatus = serviceProviderClient.getDependencyStatus(provider, providerEndpoint, false, domain, principal);
        assertEquals(dependencyStatus.getStatus(), ZMSConsts.PROVIDER_RESPONSE_ALLOW);
