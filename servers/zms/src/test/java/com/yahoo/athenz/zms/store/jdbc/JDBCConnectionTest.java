...
public class JDBCConnectionTest {
    ...
    public void testGetAllRoles() throws SQLException {
        ...
        memberRole0.setMemberName(principalName);
        ...
        memberRole1.setMemberName(principalName);
        ...
        memberRole2.setMemberName(principalName);
        ...
        memberRole3.setMemberName(principalName);
        ...
        memberRole4.setMemberName(principalName);
        ...
        memberRole5.setMemberName(principalName);

        DomainRoleMember roleMember = jdbcConn.getAllRoles(principalName);
    ...
    @Test
    public void testGetAllRolesInvalidPrincipal() throws SQLException {
        JDBCConnection jdbcConn = new JDBCConnection(mockConn, true);
        try {
            jdbcConn.getAllRoles("johndoe");
            fail();
    ...
    @Test
    public void testGetAllRolesException() throws SQLException {
        JDBCConnection jdbcConn = new JDBCConnection(mockConn, true);
    ...
    @Test
    public void testGetAllRolesNoRuleMembers() throws SQLException {
        JDBCConnection jdbcConn = new JDBCConnection(mockConn, true);
        Mockito.when(mockResultSet.getInt(1))
                .thenReturn(1);  // Principal id will be 1
        Mockito.when(mockResultSet.next())
        ...
        DomainRoleMember domainRoleMember = jdbcConn.getAllRoles("johndoe");
