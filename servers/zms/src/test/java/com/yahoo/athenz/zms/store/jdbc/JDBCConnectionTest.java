...
public class JDBCConnectionTest {
    ...
    @Test
    public void testGetRoleMemberYesWithExpiration() throws Exception {
    ...
    @Test
    public void testGetRoleMemberPendingYesWithExpiration() throws Exception {
    ...
    @Test
    public void testUpdateRoleReviewAndModTimestampSuccess() throws Exception {
        ...
        boolean requestSuccess = jdbcConn.updateRoleReviewAndModTimestamp("my-domain", "role1");
        assertTrue(requestSuccess);
    ...
    @Test
    public void testUpdateRoleReviewAndModTimestampFailure() throws Exception {
    ...
    @Test
    public void testUpdateRoleReviewAndModTimestampFailureInvalidDomain() throws Exception {
        ...
        try {
            jdbcConn.updateRoleReviewAndModTimestamp("my-domain", "role1");
            fail();
        } catch (ResourceException ex) {
            assertEquals(ex.getCode(), ResourceException.NOT_FOUND);
        }
    ...
    @Test
    public void testUpdateRoleReviewAndModTimestampFailureInvalidRole() throws Exception {
    ...
    @Test
    public void testUpdateRoleReviewAndModTimestampException() throws Exception {
