...
public class PutGroupMembershipDecisionNotificationTaskTest {
    ...
    public void testGenerateAndSendPostPutMembershipDecisionNotificationUsers() {
        ...
        List<Notification> notifications = new PutGroupMembershipDecisionNotificationTask(details, true, dbsvc, USER_DOMAIN_PREFIX, notificationToEmailConverterCommon).getNotifications();
        ...
        PutGroupMembershipDecisionNotificationTask.PutGroupMembershipDecisionNotificationToEmailConverter converter = new PutGroupMembershipDecisionNotificationTask.PutGroupMembershipDecisionNotificationToEmailConverter(notificationToEmailConverterCommon, true);
        notification.setNotificationToEmailConverter(converter);

        PutGroupMembershipDecisionNotificationTask.PutGroupMembershipDecisionNotificationToMetricConverter metricConverter = new PutGroupMembershipDecisionNotificationTask.PutGroupMembershipDecisionNotificationToMetricConverter();
    ...
    public void testGenerateAndSendPostPutMembershipNotificationNullNotificationSvc() {
        ...
        NotificationManager notificationManager = getNotificationManager(dbsvc, testfact);
        notificationManager.shutdown();
        List<Notification> notifications = new PutGroupMembershipDecisionNotificationTask(null, true, dbsvc, USER_DOMAIN_PREFIX, notificationToEmailConverterCommon).getNotifications();
        notificationManager.sendNotifications(notifications);
    ...
    public void testDescription() {
        DBService dbsvc = Mockito.mock(DBService.class);
        PutGroupMembershipDecisionNotificationTask putgroupMembershipDecisionNotificationTask = new PutGroupMembershipDecisionNotificationTask(
                new HashMap<>(),
                true,
                dbsvc,
                USER_DOMAIN_PREFIX,
    ...
    public void testGetRejectEmailBody() {
        ...
        PutGroupMembershipDecisionNotificationTask.PutGroupMembershipDecisionNotificationToEmailConverter converter = new PutGroupMembershipDecisionNotificationTask.PutGroupMembershipDecisionNotificationToEmailConverter(new NotificationToEmailConverterCommon(null), false);
    ...
    public void testGetApproveEmailBody() {
        ...
        Notification notification = new Notification(Notification.Type.GROUP_MEMBER_DECISION);
        notification.setDetails(details);
        PutGroupMembershipDecisionNotificationTask.PutGroupMembershipDecisionNotificationToEmailConverter converter = new PutGroupMembershipDecisionNotificationTask.PutGroupMembershipDecisionNotificationToEmailConverter(new NotificationToEmailConverterCommon(null), true);
        NotificationEmail notificationAsEmail = converter.getNotificationAsEmail(notification);
    ...
    public void getRejectEmailSubject() {
        Notification notification = new Notification(Notification.Type.GROUP_MEMBER_DECISION);
        PutGroupMembershipDecisionNotificationTask.PutGroupMembershipDecisionNotificationToEmailConverter converter = new PutGroupMembershipDecisionNotificationTask.PutGroupMembershipDecisionNotificationToEmailConverter(notificationToEmailConverterCommon, false);
        NotificationEmail notificationAsEmail = converter.getNotificationAsEmail(notification);
