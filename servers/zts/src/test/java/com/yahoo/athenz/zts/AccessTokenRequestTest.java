...
public class AccessTokenRequestTest {
    ...
    public void testAccessTokenRequest() {
        ...
        assertTrue(req1.isScopeResponse());
        assertFalse(req1.isOpenidScope());

        AccessTokenRequest req2 = new AccessTokenRequest("openid sports:domain");
        assertNotNull(req2);
        assertEquals("sports", req2.getDomainName());
        assertNull(req2.getRoleNames());
        assertTrue(req2.isScopeResponse());
        assertTrue(req2.isOpenidScope());

        // due to domain scope the role name one is ignored

        AccessTokenRequest req3 = new AccessTokenRequest("openid sports:domain sports:role.role1");
        assertNotNull(req3);
        assertEquals("sports", req3.getDomainName());
        assertNull(req3.getRoleNames());
        assertTrue(req3.isScopeResponse());
        ...
        assertFalse(req4.isScopeResponse());
        ...
        assertFalse(req5.isScopeResponse());
        ...
        assertFalse(req6.isScopeResponse());
