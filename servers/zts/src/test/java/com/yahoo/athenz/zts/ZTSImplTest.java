...
public class ZTSImplTest {
    ...
    public void testConfigurationSettings() {
        ...
        System.clearProperty(ZTSConsts.ZTS_PROP_OSTK_HOST_SIGNER_SERVICE);
        ...
        assertNull(ztsImpl.ostkHostSignerDomain);
        assertNull(ztsImpl.ostkHostSignerService);
        ...
        System.setProperty(ZTSConsts.ZTS_PROP_OSTK_HOST_SIGNER_SERVICE, "service");
    ...
    public void testPostAccessTokenRequest() throws IOException {
        ...
        AccessTokenResponse resp = zts.postAccessTokenRequest(context, "grant_type=client_credentials&scope=coretech:domain");
        assertNotNull(resp);
        ...
        resp = zts.postAccessTokenRequest(context1, "grant_type=client_credentials&scope=coretech:domain&expires_in=100");
        assertNotNull(resp);
    ...
    public void testPostAccessTokenRequestSingleRole() {
        ...
        AccessTokenResponse resp = zts.postAccessTokenRequest(context, "grant_type=client_credentials&scope=coretech:role.writers");
        assertNotNull(resp);
    ...
    public void testPostAccessTokenRequestOpenIdScope() {
        ...
        AccessTokenResponse resp = zts.postAccessTokenRequest(context, "grant_type=client_credentials&scope=coretech:domain openid");
        assertNotNull(resp);
    ...
    public void testPostAccessTokenRequestOpenIdScopeOnly() {
        ...
        AccessTokenResponse resp = zts.postAccessTokenRequest(context, "grant_type=client_credentials&scope=coretech:role.role999 openid");
        assertNotNull(resp);
    ...
    public void testPostAccessTokenRequestInvalidIdTokenMarshall() {
        ...
        try {
            zts.postAccessTokenRequest(context, "grant_type=client_credentials&scope=coretech:domain openid");
            fail();
        } catch (ResourceException ex) {
            assertEquals(500, ex.getCode());
