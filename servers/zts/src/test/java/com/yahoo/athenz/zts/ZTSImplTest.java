...
public class ZTSImplTest {
    ...
    public void testDetermineTokenTimeoutWithRoleExpiry() {
        ...
        Role role1 = new Role().setName("athenz:role.readers").setCertExpiryMins(10);
    ...
    public void testPostInstanceRegisterInformationInvalidHostname() throws IOException {
        ...
        // we should get a rejection here since we have a hostname
        // specified but the hostname is not in the CSR
    ...
    public void testGetConfiguredRoleExpiryTimeMinsNoSettings() {
        ...
        Set<String> roles = new HashSet<>();
        assertEquals(zts.getConfiguredRoleExpiryTimeMins(data, roles), 0);
    ...
    public void testGetConfiguredRoleExpiryTimeMinsDomainSettings() {
        ...
        Set<String> roles = new HashSet<>();
        assertEquals(zts.getConfiguredRoleExpiryTimeMins(data, roles), 120);
    ...
    public void testGetConfiguredRoleExpiryTimeMinsRoleSettings() {
        ...
        roles.add("admin");
        assertEquals(zts.getConfiguredRoleExpiryTimeMins(data, roles), 180);
    }
    ...
    public void testGetConfiguredRoleExpiryTimeMinsMultipleRoleSettings() {
        ...
        roles.add("readers");
        assertEquals(zts.getConfiguredRoleExpiryTimeMins(data, roles), 80);

        roles.add("admin");
        assertEquals(zts.getConfiguredRoleExpiryTimeMins(data, roles), 60);
