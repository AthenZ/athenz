...
public final class ZTSConsts {
    ...
    public static final String ZTS_PROP_METRIC_NAME       = "athenz.zts.metric_name";
    ...
    public static final String ZTS_PROP_LOG_UNREQUESTED_ROLES      = "athenz.zts.log_unrequested_roles";
    ...
    public static final String ZTS_PROP_CERT_EMAIL_VALIDATOR_FACTORY_CLASS = "athenz.zts.cert_email_validator_factory_class";
    public static final String ZTS_CERT_EMAIL_VALIDATOR_FACTORY_CLASS_DEFAULT = "com.yahoo.athenz.common.server.cert.impl.DefaultX509CertEmailValidatorFactory";
    ...
    public static final String ZTS_USER_CERT_SIGNER_KEY_ID_TAG = "zts.UserCertSignerKeyId";
