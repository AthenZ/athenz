...
public class DynamoDBClientSettingsZts implements DynamoDBClientSettings {
    ...
    public DynamoDBClientSettingsZts(PrivateKeyStore keyStore) {
        ...
        externalId = System.getProperty(ZTS_PROP_DYNAMODB_EXTERNAL_ID);
        minExpiryTimeStr = System.getProperty(ZTS_PROP_DYNAMODB_MIN_EXPIRY_TIME, "");
        maxExpiryTimeStr = System.getProperty(ZTS_PROP_DYNAMODB_MAX_EXPIRY_TIME, "");
