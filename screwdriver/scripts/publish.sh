...
mvn -B deploy -Dmaven.test.skip=true --projects com.yahoo.athenz:athenz-zpe-policy-updater --settings screwdriver/settings/settings-zpe-policy-updater.xml
mvn -B deploy -Dmaven.test.skip=true --projects com.yahoo.athenz:athenz-zms --settings screwdriver/settings/settings-athenz-zms.xml
mvn -B deploy -Dmaven.test.skip=true --projects com.yahoo.athenz:athenz-zts --settings screwdriver/settings/settings-athenz-zts.xml
mvn -B deploy -Dmaven.test.skip=true --projects com.yahoo.athenz:athenz-zpu --settings screwdriver/settings/settings-athenz-zpu.xml
mvn -B deploy -Dmaven.test.skip=true --projects com.yahoo.athenz:athenz-ui --settings screwdriver/settings/settings-athenz-ui.xml
mvn -B deploy -Dmaven.test.skip=true --projects com.yahoo.athenz:athenz-utils --settings screwdriver/settings/settings-athenz-utils.xml
