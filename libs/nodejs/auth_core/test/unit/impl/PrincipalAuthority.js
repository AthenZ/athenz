...
var signedToken = 'v=S1;d=athenz;n=user.test;h=test.athenz.com;a=01234abc;t=10000;e=30;k=0;z=zms;o=athenz.ci.service;i=172.168.0.1;b=tech.store,tech.item;s=signature;bk=0;bn=tech.store;bs=bsignature';

var remoteAddr = '172.168.0.1';
var publicKeyDomain = 'athenz';
var publicKeyService = 'user.test';
var publicKeyId = '0';
...
describe('PrincipalAuthority impl', function() {
  ...
  it('should test PrincipalAuthority', function() {
    ...
    expect(principalAuthority._allowedOffset).to.equal(300);
    expect(principalAuthority._ipCheckMode).to.equal('OPS_WRITE');
    expect(principalAuthority._userDomain).to.equal('user');
  });
  ...
  it('should test getHeader', function() {
    ...
    expect(principalAuthority.getHeader()).to.equal('Athenz-Principal-Auth');
  });
  ...
  it('should test _validateAuthorizeService: invalid authorizedServiceName: result null', function() {
    var principalAuthority = new PrincipalAuthority();
    var invalidSignedToken = 'v=S1;d=athenz;n=user.test;h=test.athenz.com;a=01234abc;t=10000;e=30;k=0;z=zms;o=athenz.ci.service;i=172.168.0.1;b=tech,tech.item;s=signature;bk=0;bn=tech;bs=bsignature';
    var invalidServiceToken = new PrincipalToken(invalidSignedToken);

    expect(principalAuthority._validateAuthorizeService(invalidServiceToken)).to.be.null;

    invalidSignedToken = 'v=S1;d=athenz;n=user.test;h=test.athenz.com;a=01234abc;t=10000;e=30;k=0;z=zms;o=athenz.ci.service;i=172.168.0.1;b=tech.store.,tech.item;s=signature;bk=0;bn=tech.store.;bs=bsignature';
