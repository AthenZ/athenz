...
var signedToken = 'v=U1;d=athenz;n=user.test;h=test.athenz.com;a=01234abc;t=10000;e=30;k=0;z=zms;o=athenz.ci.service;i=172.168.0.1;b=tech.store,tech.item;s=signature;bk=0;bn=tech.store;bs=bsignature';
var tokenObject = {
  version: 'U1',
  domain: 'athenz',
  name: 'user.test',
...
describe('PrincipalToken impl', function() {
  ...
  it('should test PrincipalToken: using signedToken', function() {
    ...
    expect(principalToken.getDomain()).to.equal('athenz');
    expect(principalToken.getName()).to.equal('user.test');
    ...
    expect(principalToken.getUnsignedToken()).to.equal('v=U1;d=athenz;n=user.test;h=test.athenz.com;a=01234abc;t=10000;e=30;k=0;z=zms;o=athenz.ci.service;i=172.168.0.1;b=tech.store,tech.item');
    expect(principalToken.getSignedToken()).to.equal('v=U1;d=athenz;n=user.test;h=test.athenz.com;a=01234abc;t=10000;e=30;k=0;z=zms;o=athenz.ci.service;i=172.168.0.1;b=tech.store,tech.item;s=signature;bk=0;bn=tech.store;bs=bsignature');
  });
  ...
  it('should test PrincipalToken: using signedToken: domain Null: result error', function() {
    try {
      var principalToken = new PrincipalToken('v=U1;n=user.test;h=test.athenz.com;a=01234abc;t=10000;e=30;k=0;z=zms;o=athenz.ci.service;i=172.168.0.1;s=signature;');
    } catch (e) {
  ...
  it('should test signForAuthorizedService', function() {
    var sigToken = 'v=U1;d=athenz;n=user.test;h=test.athenz.com;a=01234abc;t=10000;e=30;k=0;z=zms;o=athenz.ci.service;i=172.168.0.1;b=tech.store,tech.item;s=signature';
  ...
  it('should test isValidAuthorizedServiceToken: authorizedServices contains only entry', function() {
    var tokenStr = 'v=S1;d=athenz;n=user.test;a=01234abc;t=10000;e=30;k=0;b=tech.store;s=signature;bk=0;bs=bsignature'
  ...
  it('should test isValidAuthorizedServiceToken: authorizedServices Null and existed authorizedServiceSignature: result false', function() {
    var tokenStr = 'v=S1;d=athenz;n=user.test;a=01234abc;t=10000;e=30;k=0;s=signature;bk=0;bs=bsignature'
    var principalToken = new PrincipalToken(tokenStr);
  ...
  it('should test isValidAuthorizedServiceToken: authorizedServiceSignature Null: result false', function() {
    var tokenStr = 'v=S1;d=athenz;n=user.test;a=01234abc;t=10000;e=30;k=0;b=tech.store,tech.item;s=signature;bk=0;'
    var principalToken = new PrincipalToken(tokenStr);
  ...
  it('should test isValidAuthorizedServiceToken: authorizedServices doesn\'t include authorizedServiceName: result false', function() {
    var tokenStr = 'v=S1;d=athenz;n=user.test;a=01234abc;t=10000;e=30;k=0;b=tech.store,tech.item;s=signature;bk=0;bn=tech.sample;bs=bsignature'
    var principalToken = new PrincipalToken(tokenStr);
  ...
  it('should test isValidAuthorizedServiceToken: No service name and Authorized service list contains multiple entries: result false', function() {
    var tokenStr = 'v=S1;d=athenz;n=user.test;a=01234abc;t=10000;e=30;k=0;b=tech.store,tech.item;s=signature;bk=0;bs=bsignature'
    var principalToken = new PrincipalToken(tokenStr);
