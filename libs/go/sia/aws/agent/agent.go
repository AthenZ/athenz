...
func RegisterInstance(data []*attestation.AttestationData, ztsUrl string, opts *sc.Options, docExpiryCheck bool) error {
...
func RefreshInstance(data []*attestation.AttestationData, ztsUrl string, opts *sc.Options) error {
	for i, svc := range opts.Services {
...
func registerSvc(svc sc.Service, data *attestation.AttestationData, ztsUrl string, opts *sc.Options) error {
...
func refreshSvc(svc sc.Service, data *attestation.AttestationData, ztsUrl string, opts *sc.Options) error {
