...
func TestGetK8SHostnames(test *testing.T) {
	...
	tests := []struct {
		...
		{"pod-ip-svc", "", "10.11.12.13", "api-ns", "api", "", []string{"10-11-12-13.api-ns.pod.cluster.local", "10-11-12-13.api.api-ns.pod.cluster.local", "api.api-ns.svc.cluster.local"}},
		...
		{"pod-all-values", "pod-1", "10.11.12.13", "api-ns", "api", "api-sub", []string{"10-11-12-13.api-ns.pod.cluster.local", "10-11-12-13.api.api-ns.pod.cluster.local", "pod-1.api-sub.api-ns.svc.cluster.local", "api.api-ns.svc.cluster.local"}},
	}
	for _, tt := range tests {
		test.Run(tt.name, func(t *testing.T) {
			...
			assert.Equal(t, ns, tt.siaPodNamespace)
