...
public class PulsarChangeSubscriber<T> implements ChangeSubscriber<T> {
    ...
    public PulsarChangeSubscriber(String serviceUrl, String topicName, String subscriptionName,
            SubscriptionType subscriptionType, AthenzPulsarClient.TlsConfig tlsConfig) {

        ConsumerConfigurationData<byte[]> consumerConfiguration = defaultConsumerConfig(Collections.singleton(topicName),
