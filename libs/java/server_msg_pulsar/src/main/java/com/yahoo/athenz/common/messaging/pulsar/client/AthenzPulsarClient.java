...
public class AthenzPulsarClient {
    ...
    public static PulsarClientImpl createPulsarClient(String serviceUrl, TlsConfig tlsConfig) {
        if (tlsConfig == null || tlsConfig.tlsCertFilePath == null || tlsConfig.tlsKeyFilePath == null ||
                tlsConfig.tlsTrustCertsFilePath == null) {
    ...
    public static <T> Producer<T> createProducer(PulsarClientImpl pulsarClient, ProducerConfigurationData producerConfiguration,
            Schema<T> schema) {
        ...
        try {
            ...
            LOG.error("Failed to create pulsar producer: {}", ex.getMessage(), ex);
    ...
    public static ConsumerConfigurationData<byte[]> defaultConsumerConfig(Set<String> topicNames, String subscriptionName,
    ...
    public static Consumer<byte[]> createConsumer(String serviceUrl, Set<String> topicNames, String subscriptionName,
            SubscriptionType subscriptionType, TlsConfig tlsConfig) {
        ConsumerConfigurationData<byte[]> consumerConfiguration = defaultConsumerConfig(topicNames,
    ...
    public static <T> Consumer<T> createConsumer(PulsarClientImpl pulsarClient, ConsumerConfigurationData<T> consumerConfiguration,
            Schema<T> schema) {
        ...
        try {
            ...
            LOG.error("Failed to create pulsar consumer: {}", ex.getMessage(), ex);
