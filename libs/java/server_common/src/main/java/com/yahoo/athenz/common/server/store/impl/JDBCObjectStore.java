...
public class JDBCObjectStore implements ObjectStore {
    ...
    @Override
    public ObjectStoreConnection getConnection(boolean autoCommit, boolean readWrite) throws ServerResourceException {
        ...
        try {
            ...
            throw Utils.error(ServerResourceException.SERVICE_UNAVAILABLE, ex.getMessage(), caller);
        }
    }
