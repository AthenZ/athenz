...
public final class JDBCConsts {
    ...
    public static final String DB_COLUMN_AS_MEMBER_PRINCIPAL = "member_principal";
    ...
    public static final String DB_COLUMN_AS_DOMAIN_MEMBER_EXPIRY_DAYS = "domain_member_expiry_days";
