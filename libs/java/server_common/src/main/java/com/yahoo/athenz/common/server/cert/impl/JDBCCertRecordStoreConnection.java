...
public class JDBCCertRecordStoreConnection implements CertRecordStoreConnection {
    ...
    @Override
    public boolean updateX509CertRecord(X509CertRecord certRecord) throws ServerResourceException {
    ...
    @Override
    public boolean insertX509CertRecord(X509CertRecord certRecord) throws ServerResourceException {
    ...
    @Override
    public boolean deleteX509CertRecord(String provider, String instanceId, String service) throws ServerResourceException {
    ...
    public List<X509CertRecord> updateUnrefreshedCertificatesNotificationTimestamp(String lastNotifiedServer,
                                                                      ...
                                                                      String provider) throws ServerResourceException {
    ...
    private List<X509CertRecord> getNotifyUnrefreshedCertificates(String lastNotifiedServer, long lastNotifiedTime) throws ServerResourceException {
    ...
    ServerResourceException sqlError(SQLException ex, String caller) {
        ...
        if (ex instanceof SQLTimeoutException) {
            ...
            msg = ex.getMessage() + ", state: " + sqlState + ", code: " + ex.getErrorCode() + ", caller: " + caller;
        }
