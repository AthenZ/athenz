 ...
 */
package com.yahoo.athenz.common.server;

public class ServerResourceException extends Exception {
    ...
    public ServerResourceException(int code) {
        this(code, symbolForCode(code));
    }

    public ServerResourceException(int code, String message) {
        this.code = code;
