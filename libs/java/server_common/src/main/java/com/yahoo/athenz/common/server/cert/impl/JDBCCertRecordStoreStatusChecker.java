...
public class JDBCCertRecordStoreStatusChecker implements StatusChecker {
    ...
    private final JDBCCertRecordStore jdbcCertRecordStore;
    ...
    public void check() throws StatusCheckException {
        try (CertRecordStoreConnection ignored = jdbcCertRecordStore.getConnection()) {
            // do nothing. we just want to make sure if we can connect to the database
        } catch (Throwable e) {
