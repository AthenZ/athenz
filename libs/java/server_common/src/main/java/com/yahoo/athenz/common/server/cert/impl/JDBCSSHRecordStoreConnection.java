...
public class JDBCSSHRecordStoreConnection implements SSHRecordStoreConnection {
    ...
    @Override
    public SSHCertRecord getSSHCertRecord(String instanceId, String service) throws ServerResourceException {
    ...
    @Override
    public boolean updateSSHCertRecord(SSHCertRecord sshCertRecord) throws ServerResourceException {
    ...
    @Override
    public boolean insertSSHCertRecord(SSHCertRecord sshCertRecord) throws ServerResourceException {
    ...
    @Override
    public boolean deleteSSHCertRecord(String instanceId, String service) throws ServerResourceException {
