...
public class ServerResourceContext {
    ...
    public ServerResourceContext(ServletContext servletContext, HttpServletRequest request, HttpServletResponse response,
     ...
     * @return Principal object
     */
    public Principal authenticate() throws ServerResourceException {
     ...
     */
    public Principal authenticate(boolean optionalAuth) throws ServerResourceException {
        if (!checked) {
            checked = true;
     ...
     */
    public void authorize(String action, String resource, String trustedDomain) throws ServerResourceException {
     ...
     */
    public void sendAuthenticateChallenges(ServerResourceException exc) {

        // first check to see if this is an auth failure and if
        // that's the case include the WWW-Authenticate challenge

        if (exc.getCode() != ServerResourceException.UNAUTHORIZED) {
            return;
        }
