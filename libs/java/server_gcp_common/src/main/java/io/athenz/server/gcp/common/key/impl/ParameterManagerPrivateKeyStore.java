...
public class ParameterManagerPrivateKeyStore implements PrivateKeyStore {
    ...
    private static final String ATHENZ_PROP_GCP_PROJECT_ID = "athenz.gcp.project_id";
    private static final String ATHENZ_PROP_GCP_LOCATION = "athenz.gcp.location";
    ...
    ParameterManagerPrivateKeyStore(final ParameterManagerClient parameterManagerClient) {
        this.client = parameterManagerClient;

        projectId = System.getProperty(ATHENZ_PROP_GCP_PROJECT_ID, "default-project-id");
        location = System.getProperty(ATHENZ_PROP_GCP_LOCATION, "global");
    }
    ...
    public ServerPrivateKey getPrivateKey(String service, String serverHostName, String serverRegion, String algorithm) {
        return PrivateKeyStoreUtil.getPrivateKeyFromCloudParameter(service, serverRegion, algorithm, this::getParameter);
    }
