...
public class Config {
    ...
    public static final String PROP_PREFIX = "yahoo.auth.zms_syncer_aws.";
    ...
    public static final String SYNC_CFG_PARAM_AWS_CONNECT_TIMEOUT = "aws_connect_timeout";
    public static final String SYNC_CFG_PARAM_AWS_REQUEST_TIMEOUT = "aws_request_timeout";
    public static final String SYNC_CFG_PARAM_ATHENZ_SVC_KEYFILE = "key_file";
    public static final String SYNC_CFG_PARAM_ATHENZ_SVC_CERT = "cert_file";
    public static final String SYNC_CFG_PARAM_TRUST_STORE_PATH = "truststore_path";
    public static final String SYNC_CFG_PARAM_TRUST_STORE_PASSWORD = "truststore_password";
    ...
    public static final String ZMS_CFG_PARAM_ZMS_URL = "zmsUrl";
    ...
    public Struct parseJsonConfigFile(final String fileName) {
    ...
    public SyncerDomainStates parseSyncerDomainStates(final String fileName) {
    ...
    private void mergeSyncConfigFile() {
        ...
        try {
            ...
            // Let's process remaining entries from the conf file that are not in SYNC_CFG_PARAMS
            Set<String> syncCfgParams = Set.of(SYNC_CFG_PARAMS);
            for (String name : fileParams.names()) {
                if (!propertyMap.containsKey(name) && !syncCfgParams.contains(name)) {
                    final String val = fileParams.getString(name);
                    if (val != null) {
                        propertyMap.put(name, val);
                    }
                }
