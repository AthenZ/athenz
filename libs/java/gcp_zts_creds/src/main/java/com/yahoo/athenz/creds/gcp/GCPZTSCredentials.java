...
public class GCPZTSCredentials {
    ...
    GCPZTSCredentials(Builder builder) throws KeyRefresherException, IOException, InterruptedException {
        ...
        final String scope = URLEncoder.encode(ZTSClient.generateIdTokenScope(builder.domainName, builder.roleNames), "UTF-8");
        final String redirectUri = URLEncoder.encode(ZTSClient.generateRedirectUri(builder.clientId, builder.redirectUriSuffix), "UTF-8");
