...
public class S3PrivateKeyStoreTest {
    ...
    @Test
    public void testS3PrivateKeyStore() {
        ...
        S3PrivateKeyStore awsPrivateKeyStore = new S3PrivateKeyStore(s3, kms);
    ...
    public void testGetPrivateKey() {
        ...
        S3PrivateKeyStoreFactory awsPrivateKeyStoreFactory = new S3PrivateKeyStoreFactory();
        assertTrue(awsPrivateKeyStoreFactory.create() instanceof S3PrivateKeyStore);

        S3PrivateKeyStore awsPrivateKeyStore = new S3PrivateKeyStore();
    ...
    public void testGetApplicationSecret() {
        ...
        S3PrivateKeyStore awsPrivateKeyStore = new S3PrivateKeyStore();
        S3PrivateKeyStore spyAWS = Mockito.spy(awsPrivateKeyStore);
    ...
    public void testGetKMS() {
        S3Client s3 = mock(S3Client.class);
        KmsClient kms = mock(KmsClient.class);
        S3PrivateKeyStore privateKeyStore = new S3PrivateKeyStore(s3, kms);
    ...
    private void testGetPrivateKeyAlgorithm(final String service) throws IOException {
        ...
        assertEquals(serverPrivateKey.getAlgorithm(), "RS256");
