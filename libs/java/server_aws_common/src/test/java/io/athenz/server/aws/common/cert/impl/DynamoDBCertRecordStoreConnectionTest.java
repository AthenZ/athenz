...
public class DynamoDBCertRecordStoreConnectionTest {
    ...
    public void testInsertX509Record() {
        ...
        Assert.assertEquals(DynamoDBUtils.getString(item, "instanceId"),"1234");
        Assert.assertEquals(DynamoDBUtils.getString(item, "service"), "cn");
        Assert.assertEquals(DynamoDBUtils.getString(item, "hostName"), "hostname");
    ...
    public void testInsertX509RecordNoHostname() {
        ...
        Assert.assertEquals(DynamoDBUtils.getString(item, "hostName"), "athenz.provider:cn:1234");
    ...
    public void testUpdateUnrefreshedCertificatesNotificationTimestamp() {
        ...
        Map<String, AttributeValue> unNotified = ServerCommonTestUtils.generateAttributeValues(
        ...
        Map<String, AttributeValue> rebootstrapped = ServerCommonTestUtils.generateAttributeValues(
                "home.test.service3", "rebootstrapped", Long.toString(sevenDaysAgo), Long.toString(sevenDaysAgo),
                "testServer", null, "testHost2");

        Map<String, AttributeValue> willBeUpdatedByOtherZts = ServerCommonTestUtils.generateAttributeValues(
