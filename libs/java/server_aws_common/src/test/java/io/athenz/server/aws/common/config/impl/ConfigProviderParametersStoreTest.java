 ...
 */
package io.athenz.server.aws.common.config.impl;
...
public class ConfigProviderParametersStoreTest {

    @Test
    public void testConfigProviderParametersStore() {
        ConfigProviderParametersStore provider = new ConfigProviderParametersStore() {
            @Override
        ...
        ConfigProviderParametersStore.ConfigSourceAwsParametersStore source = provider.tryToBuildConfigSource("aws-param-store://test/prefix");
