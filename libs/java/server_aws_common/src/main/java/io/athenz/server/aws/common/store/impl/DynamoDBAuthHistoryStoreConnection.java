...
public class DynamoDBAuthHistoryStoreConnection implements AuthHistoryStoreConnection {
    ...
    @Override
    public AuthHistoryDependencies getAuthHistory(String domain) throws ServerResourceException {
        try {
            ...
            throw Utils.error(ServerResourceException.NOT_FOUND, resourceNotFoundException.getMessage(), "getAuthHistory");
        }
    }
