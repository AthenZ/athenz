 ...
 * </pre>
 */
public class ConfigProviderParametersStore extends ConfigProvider {
    ...
    public static class ConfigSourceAwsParametersStore extends ConfigSource {
        ...
        public String toString() {
            return "AWS-Parameters-Store path " + com.yahoo.athenz.common.server.util.Utils.jsonSerializeForLog(path);
        }
    }
}
