...
func init() {
	...
	tTransportPolicyIngressRule.Field("identifier", "EntityName", false, nil, "Policy Identifier")
	...
	tTransportPolicyEgressRule.Field("identifier", "EntityName", false, nil, "Policy Identifier")
