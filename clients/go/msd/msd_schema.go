...
func init() {
	...
	tWorkloadRequest := rdl.NewStructTypeBuilder("Struct", "WorkloadRequest")
	tWorkloadRequest.Comment("request type to search all workloads for a domain and selected list of its services")
	tWorkloadRequest.Field("domainName", "DomainName", false, nil, "name of the domain")
	tWorkloadRequest.ArrayField("serviceNames", "EntityName", false, "list of service names")
	sb.AddType(tWorkloadRequest.Build())

	tWorkloadRequests := rdl.NewStructTypeBuilder("Struct", "WorkloadRequests")
	tWorkloadRequests.Comment("request type to search all workloads for a list of services grouped by domains")
	tWorkloadRequests.ArrayField("workloadRequest", "WorkloadRequest", false, "list of workload requests by services, grouped by domain")
	tWorkloadRequests.Field("fetchStaticTypeWorkloads", "Bool", true, true, "whether to fetch static type workloads")
	tWorkloadRequests.Field("fetchDynamicTypeWorkloads", "Bool", true, true, "whether to fetch dynamic type workloads")
	tWorkloadRequests.ArrayField("applicableStaticTypes", "StaticWorkloadType", true, "list of applicable static workload types, if not set then that means all. Applicable only if fetchStaticTypeWorkloads is enabled")
	tWorkloadRequests.Field("resolveStaticWorkloads", "Bool", true, false, "resolve static workloads to IPs, if applicable")
	sb.AddType(tWorkloadRequests.Build())
	...
	mGetWorkloadsByDomainAndService := rdl.NewResourceBuilder("Workloads", "POST", "/workloads")
	...
	mGetWorkloadsByDomainAndService.Input("request", "WorkloadRequests", false, "", "", false, nil, "workload search request")
