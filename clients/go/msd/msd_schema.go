...
func init() {
	...
	mRegisterAdditionalInstance := rdl.NewResourceBuilder("Workloads", "PUT", "/domain/{domainName}/service/{serviceName}/register/instance")
	mRegisterAdditionalInstance.Comment("Api to register an additional instance which can have static or dynamic or both IPs")
	mRegisterAdditionalInstance.Name("registerAdditionalInstance")
	mRegisterAdditionalInstance.Input("domainName", "DomainName", true, "", "", false, nil, "name of the domain")
	mRegisterAdditionalInstance.Input("serviceName", "EntityName", true, "", "", false, nil, "name of the service")
	mRegisterAdditionalInstance.Input("instance", "String", false, "", "", false, nil, "Generic struct to pass instance meta data")
	mRegisterAdditionalInstance.Auth("update", "{domainName}:service.{serviceName}", false, "")
	mRegisterAdditionalInstance.Expected("NO_CONTENT")
	mRegisterAdditionalInstance.Exception("BAD_REQUEST", "ResourceError", "")
	mRegisterAdditionalInstance.Exception("FORBIDDEN", "ResourceError", "")
	mRegisterAdditionalInstance.Exception("NOT_FOUND", "ResourceError", "")
	mRegisterAdditionalInstance.Exception("TOO_MANY_REQUESTS", "ResourceError", "")
	mRegisterAdditionalInstance.Exception("UNAUTHORIZED", "ResourceError", "")
	sb.AddResource(mRegisterAdditionalInstance.Build())

	mDeregisterAdditionalInstance := rdl.NewResourceBuilder("Workloads", "DELETE", "/domain/{domainName}/service/{serviceName}/register/instance")
	mDeregisterAdditionalInstance.Comment("Api to deregister an additional instance which can have static or dynamic or both IPs")
	mDeregisterAdditionalInstance.Name("deregisterAdditionalInstance")
	mDeregisterAdditionalInstance.Input("domainName", "DomainName", true, "", "", false, nil, "name of the domain")
	mDeregisterAdditionalInstance.Input("serviceName", "EntityName", true, "", "", false, nil, "name of the service")
	mDeregisterAdditionalInstance.Input("instance", "String", false, "", "", false, nil, "Generic struct to pass instance meta data")
	mDeregisterAdditionalInstance.Auth("update", "{domainName}:service.{serviceName}", false, "")
	mDeregisterAdditionalInstance.Expected("NO_CONTENT")
	mDeregisterAdditionalInstance.Exception("BAD_REQUEST", "ResourceError", "")
	mDeregisterAdditionalInstance.Exception("FORBIDDEN", "ResourceError", "")
	mDeregisterAdditionalInstance.Exception("NOT_FOUND", "ResourceError", "")
	mDeregisterAdditionalInstance.Exception("TOO_MANY_REQUESTS", "ResourceError", "")
	mDeregisterAdditionalInstance.Exception("UNAUTHORIZED", "ResourceError", "")
	sb.AddResource(mDeregisterAdditionalInstance.Build())
