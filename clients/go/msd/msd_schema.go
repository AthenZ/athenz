...
func init() {
	...
	tCompositeInstance.Field("instance", "EntityName", false, nil, "instance name/id")
	tCompositeInstance.Field("instanceType", "String", false, nil, "instance type")
	...
	mPostCompositeInstance := rdl.NewResourceBuilder("Workloads", "PUT", "/domain/{domainName}/service/{serviceName}/workload/discover/instance")
	mPostCompositeInstance.Comment("Api to discover an additional instance which can have static or dynamic or both IPs")
	mPostCompositeInstance.Name("postCompositeInstance")
	mPostCompositeInstance.Input("domainName", "DomainName", true, "", "", false, nil, "name of the domain")
	mPostCompositeInstance.Input("serviceName", "EntityName", true, "", "", false, nil, "name of the service")
	mPostCompositeInstance.Input("instance", "CompositeInstance", false, "", "", false, nil, "Generic instance")
	mPostCompositeInstance.Auth("update", "{domainName}:service.{serviceName}", false, "")
	mPostCompositeInstance.Expected("NO_CONTENT")
	mPostCompositeInstance.Exception("BAD_REQUEST", "ResourceError", "")
	mPostCompositeInstance.Exception("FORBIDDEN", "ResourceError", "")
	mPostCompositeInstance.Exception("NOT_FOUND", "ResourceError", "")
	mPostCompositeInstance.Exception("TOO_MANY_REQUESTS", "ResourceError", "")
	mPostCompositeInstance.Exception("UNAUTHORIZED", "ResourceError", "")
	sb.AddResource(mPostCompositeInstance.Build())

	mDeleteCompositeInstance := rdl.NewResourceBuilder("Workloads", "DELETE", "/domain/{domainName}/service/{serviceName}/workload/discover/instance")
	...
	mDeleteCompositeInstance.Input("instance", "CompositeInstance", false, "", "", false, nil, "Generic instance")
