...
func init() {
	...
	rPostInstanceRegisterInformation := rdl.NewResourceBuilder("InstanceIdentity", "POST", "/instance")
	rPostInstanceRegisterInformation.Input("info", "InstanceRegisterInformation", false, "", "", false, nil, "")
	rPostInstanceRegisterInformation.Output("location", "String", "Location", false, "return location for subsequent patch requests")
	rPostInstanceRegisterInformation.Expected("CREATED")
	rPostInstanceRegisterInformation.Exception("BAD_REQUEST", "ResourceError", "")
	rPostInstanceRegisterInformation.Exception("FORBIDDEN", "ResourceError", "")
	rPostInstanceRegisterInformation.Exception("INTERNAL_SERVER_ERROR", "ResourceError", "")
	rPostInstanceRegisterInformation.Exception("UNAUTHORIZED", "ResourceError", "")
	sb.AddResource(rPostInstanceRegisterInformation.Build())

	rPostInstanceRefreshInformation := rdl.NewResourceBuilder("InstanceIdentity", "POST", "/instance/{provider}/{domain}/{service}/{instanceId}")
	rPostInstanceRefreshInformation.Comment("only TLS authentication is allowed")
	rPostInstanceRefreshInformation.Input("provider", "ServiceName", true, "", "", false, nil, "the provider service name (i.e. \"aws.us-west-2\", \"paas.manhattan.corp-gq1\")")
	rPostInstanceRefreshInformation.Input("domain", "DomainName", true, "", "", false, nil, "the domain of the instance")
	rPostInstanceRefreshInformation.Input("service", "SimpleName", true, "", "", false, nil, "the service this instance is supposed to run")
	rPostInstanceRefreshInformation.Input("instanceId", "PathElement", true, "", "", false, nil, "unique instance id within provider's namespace")
	rPostInstanceRefreshInformation.Input("info", "InstanceRefreshInformation", false, "", "", false, nil, "the refresh request")
	rPostInstanceRefreshInformation.Auth("launch", "{domain}:provider.{provider}", false, "")
	rPostInstanceRefreshInformation.Exception("BAD_REQUEST", "ResourceError", "")
	rPostInstanceRefreshInformation.Exception("FORBIDDEN", "ResourceError", "")
	rPostInstanceRefreshInformation.Exception("INTERNAL_SERVER_ERROR", "ResourceError", "")
	rPostInstanceRefreshInformation.Exception("NOT_FOUND", "ResourceError", "")
	rPostInstanceRefreshInformation.Exception("UNAUTHORIZED", "ResourceError", "")
	sb.AddResource(rPostInstanceRefreshInformation.Build())

	rDeleteInstanceIdentity := rdl.NewResourceBuilder("InstanceIdentity", "DELETE", "/instance/{provider}/{domain}/{service}/{instanceId}")
	rDeleteInstanceIdentity.Input("provider", "ServiceName", true, "", "", false, nil, "the provider service name (i.e. \"aws.us-west-2\", \"paas.manhattan.corp-gq1\")")
	rDeleteInstanceIdentity.Input("domain", "DomainName", true, "", "", false, nil, "the domain of the instance")
	rDeleteInstanceIdentity.Input("service", "SimpleName", true, "", "", false, nil, "the service this instance is supposed to run")
	rDeleteInstanceIdentity.Input("instanceId", "PathElement", true, "", "", false, nil, "unique instance id within provider's namespace")
	rDeleteInstanceIdentity.Auth("delete", "{domain}:instance.{instanceId}", false, "")
	rDeleteInstanceIdentity.Expected("NO_CONTENT")
	rDeleteInstanceIdentity.Exception("BAD_REQUEST", "ResourceError", "")
	rDeleteInstanceIdentity.Exception("FORBIDDEN", "ResourceError", "")
	rDeleteInstanceIdentity.Exception("INTERNAL_SERVER_ERROR", "ResourceError", "")
	rDeleteInstanceIdentity.Exception("NOT_FOUND", "ResourceError", "")
	rDeleteInstanceIdentity.Exception("UNAUTHORIZED", "ResourceError", "")
	sb.AddResource(rDeleteInstanceIdentity.Build())
