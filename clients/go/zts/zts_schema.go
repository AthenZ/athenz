...
func init() {
	...
	mGetResourceAccess.Input("isCaseSensitive", "BOOL", false, "casesensitive", "", true, nil, "usually false. If true, keep action and resource case-sensitive")
	...
	mGetResourceAccessExt.Input("isCaseSensitive", "BOOL", false, "casesensitive", "", true, nil, "usually false. If true, keep action and resource case-sensitive")
