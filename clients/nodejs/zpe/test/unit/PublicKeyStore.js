...
describe('PublicKeyStore', function() {
  ...
  it('should test PublicKeyStore fails', function() {
    ...
    }).to.throw(Error, 'ENOENT: no such file or directory, open \'/home/athenz/conf/athenz/athenz.conf\'');
  ...
  it('should test PublicKeyStore fails with empty key', function() {
    PublicKeyStore.setConfig({
      zpeClient: {
        logLevel: 'debug',
        policyDir: policyDir,
        confFileName: process.cwd() + '/test/resources/athenz.empty.conf',
        tokenRefresh: 1800,
        policyRefresh: 1800,
        allowedOffset: 300,
        disableCache: false,
    ...
    PublicKeyStore.setConfig({
      zpeClient: {
        logLevel: 'debug',
        policyDir: policyDir,
        confFileName: process.cwd() + '/test/resources/athenz.empty.publickey.conf',
        tokenRefresh: 1800,
        policyRefresh: 1800,
        allowedOffset: 300,
        disableCache: false,
  ...
  it('should test PublicKeyStore getZtsKey', function() {
    var publicKeyStore = new PublicKeyStore();
    expect(publicKeyStore.getZtsKey('0')).to.deep.equal(YBase64.ybase64Decode('--'));
  ...
  it('should test PublicKeyStore getZmsKey', function() {
    var publicKeyStore = new PublicKeyStore();
    expect(publicKeyStore.getZmsKey('0')).to.deep.equal(YBase64.ybase64Decode('--'));
